...
def login():
    ...
    #check if password can generate the same hash after salting
...
# 1. Have owners retrieve working on front end
# 2. Have add pets form working on front end
# 3. Add CRUD operations for the rest of backend, and see if it corresponds/works with frontend code. If not,
# 4. Add frontend code to make CRUD operations work
# """